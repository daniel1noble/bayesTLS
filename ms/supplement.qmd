...
# Defensive: if a reused R session already has freqTLS attached, detach it so the
# bare bayesTLS functions used throughout are never masked. `freqTLS::` calls in
# the freqTLS section still work unattached; harmless when it is not attached.
