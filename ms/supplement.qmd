...
tdt_function_tour <- tibble::tribble(
  ...
  "Plotting",         "plot_survival_curves()",             "Posterior curves with observed proportion overlay; by default each curve is clipped to its observed duration range (`clip_to_observed`).",
...
# plot_survival_curves() clips each curve to its observed duration range by
# default (aphids were exposed for far shorter times at hotter temperatures).
