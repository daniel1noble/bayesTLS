...
## Heat injury under three reference traces {#sec-shrimp-hi}
...
#| fig-cap: "The three reference temperature traces used for the shrimp heat-injury prediction. Baseline 17 °C (shrimp natural holding temperature); 1-hour spikes at 28 °C; the dashed line marks the damage threshold T_c set at the lower 95% credible bound of T_crit."
#| fig-width: 7
#| fig-height: 4
...
#| fig-cap: "Cumulative heat injury (top) and predicted survival (bottom) for brown shrimp under the multi-spike trace, **no repair**. Posterior median lines and 95% credible bands."
#| fig-width: 7
#| fig-height: 5
...
#| fig-cap: "Same multi-spike trace as above, this time **with Sharpe-Schoolfield repair** active (`r_ref = 0.005` doses per hour at 17 °C). Repair fully offsets the spike damage at sub-T_c baseline."
#| fig-width: 7
#| fig-height: 5

plot_heat_injury(shrimp_hi_repair)
```
...
shrimp_hi_table <- dplyr::bind_rows(
  ...
  final_row(shrimp_hi$multi_spike)  |> dplyr::mutate(Scenario = "Multi spike",
                                                     Repair = "None"),
  final_row(shrimp_hi_repair)       |> dplyr::mutate(Scenario = "Multi spike",
