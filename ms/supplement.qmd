...
tdt_function_tour <- tibble::tribble(
  ...
  "TDT quantities",   "derive_tdt_curve()",                 "Time to threshold survival across temperature. Default `target_surv = \"relative\"` (`(low + up)/2` per draw); pass `\"absolute\"` (the 50% LT50) or a numeric threshold. Per group via `by =`.",
