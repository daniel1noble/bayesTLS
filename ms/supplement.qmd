...
tdt_function_core <- tibble::tribble(
  ...
  "Extract",      "tls()",                       "Derive z, CTmax and (for lethal endpoints) T_crit per moderator group from ANY fitted 4PL, including hand-coded `brms` models (`by =`); `target_surv` picks the relative or absolute threshold.",
