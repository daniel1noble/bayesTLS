...
We've made a bunch of functions that can be used to help users apply the approaches described in the main manuscript and supplement. To load the functions, copy the code chunk and run it in your R console. 
