...
@tbl-function-tour lists every exported function in the library, grouped by pipeline stage. Each function is single-purpose; the full documentation (with runnable `@examples`) lives in the corresponding R file.
